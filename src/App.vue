    ...
    <div class="h-screen bg-white dark:bg-[#191a19] text-gray-900 dark:text-gray-200 p-6">
        <form @submit.prevent="submit" class="max-w-2xl mx-auto">
            ...
            <div class="flex items-center gap-4 mt-4">
                ...
                <button @click="condition = !condition" class="bg-gray-500 text-white rounded py-2 px-5 hover:bg-gray-900 transition hover:active:bg-gray-950 dark:bg-gray-700 dark:hover:bg-gray-800 dark:hover:active:bg-gray-900">
                    Toggle Condition
